...
type DropdownOption = 'upload-pdf' | 'create-note' | null;
      ...
      <div className="mb-6">
        ...
        <div className="relative inline-block">
          ...
          >
            ...
            <span className="font-medium text-gray-700">PDF Note</span>
            <svg
              className={cn(
          ...
          {/* Dropdown Menu */}
          {showDropdown && (
            <div className="absolute top-full mt-2 left-0 w-56 bg-gray-900 text-white rounded-lg shadow-lg py-2 z-10">
              <button
